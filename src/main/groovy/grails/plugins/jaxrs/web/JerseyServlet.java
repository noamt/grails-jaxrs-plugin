...
public class JerseyServlet extends SpringServlet {
     ...
     * {@link JaxrsContext.Config} then Jersey is configured with extra paths for scanning
     * {@link Provider} classes.
     *
     * @param servletConfig -  TODO add desc
     *
     * @see JaxrsContext.Config#getJaxrsProviderExtraPaths()
     */
    @Override
    public void init(ServletConfig servletConfig) throws ServletException {
        if (servletConfig instanceof JaxrsContext.Config) {
            init((JaxrsContext.Config)servletConfig);
        }
     ...
     * @see JaxrsContext.Config#getJaxrsProviderExtraPaths()
     */
    void init(JaxrsContext.Config config) {
