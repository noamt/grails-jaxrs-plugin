...
import grails.plugins.jaxrs.support.DomainObjectReaderSupport
 ...
 * <code>grails.plugins.jaxrs.doreader.disable</code> to <code>true</code> in the
 * application config.
 *
...
class DomainObjectReader extends DomainObjectReaderSupport {
    ...
    protected boolean isEnabled() {
        !grailsApplication.config.grails.plugins.jaxrs.doreader.disable
    }
}
